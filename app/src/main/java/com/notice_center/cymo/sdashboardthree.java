...
public class sdashboardthree extends FragmentActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadFragments(new HomeFragmentThree());
    ...
    public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.s_homeId:
                selectedFragment = new HomeFragmentThree();
                break;
            case R.id.todoId:
                selectedFragment = new ToDoFragment();
                break;
            case R.id.s_searchId:
                selectedFragment = new SearchFragmentThree();
                break;
