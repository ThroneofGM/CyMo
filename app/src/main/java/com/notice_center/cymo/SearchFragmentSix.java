...
public class SearchFragmentSix extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FirebaseRecyclerOptions<fileinfo> options =
                new FirebaseRecyclerOptions.Builder<fileinfo>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Bsc CS").orderByChild("spinner").equalTo("Sixth"), fileinfo.class)
                        .build();
