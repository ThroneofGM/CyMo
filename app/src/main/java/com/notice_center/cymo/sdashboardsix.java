...
public class sdashboardsix extends FragmentActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadFragments(new HomeFragmentSix());
    ...
    public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.s_homeId:
                selectedFragment = new HomeFragmentSix();
                break;
            case R.id.todoId:
                selectedFragment = new ToDoFragment();
                break;
            case R.id.s_searchId:
                selectedFragment = new SearchFragmentSix();
                break;
