...
public class sdashboardfour extends FragmentActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadFragments(new HomeFragmentFour());
    ...
    public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.s_homeId:
                selectedFragment = new HomeFragmentFour();
                break;
            case R.id.todoId:
                selectedFragment = new ToDoFragment();
                break;
            case R.id.s_searchId:
                selectedFragment = new SearchFragmentFour();
                break;
