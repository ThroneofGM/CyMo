...
public class sdashboardtwo extends FragmentActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadFragments(new HomeFragmentTwo());
    ...
    public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.s_homeId:
                selectedFragment = new HomeFragmentTwo();
                break;
            case R.id.todoId:
                selectedFragment = new ToDoFragment();
                break;
            case R.id.s_searchId:
                selectedFragment = new SearchFragmentTwo();
                break;
